...
{p 4 4}
Execute {stata "net from http://metodo.uab.cat/stata"} for install. 
...
{p 4 4}{stata "use http://metodo.uab.cat/stata/AlcoholTR.dta":. use http://metodo.uab.cat/stata/AlcoholTR.dta}{p_end}
