*! version 0.0.1  18apr2018 - ttest.ado original code v1.1.0 (16dec2014) modified by R Sesma
program define ttestx, rclass byable(recall)
	version 6, missing
...
*/
        ...
        _ttestx by ttesti `level' `touse' `varlist' `by' `unequal' `welch' `reverse'
	ret add
end
